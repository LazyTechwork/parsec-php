...
final class EventHistoryQueryParams
{
    ...
    /**
     * @var array<int|TransactionKey> Массив ключей типов транзакций. В качестве параметра можно использовать один или несколько ключей транзакций из приведенной ниже таблицы.
     */
     ...
     * @param array<int|TransactionKey> $TransactionTypes  Массив ключей типов транзакций. В качестве параметра можно использовать один или несколько ключей транзакций из приведенной ниже таблицы.
