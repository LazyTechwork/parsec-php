...
class ParsecClient
{
     ...
     * @throws SoapFault
     */
    public function call(ParsecMethod|string $name, array $args, array|null $options = null, \SoapHeader|array|null $inputHeaders = null, array &$outputHeaders = null): mixed
    {
